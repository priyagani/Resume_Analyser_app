...
# ---------------- End Resume Extraction Functions ----------------

def fetch_yt_video(link):
    return "Resume Tips Video"
...
connection = pymysql.connect(host='localhost', user='root', password='8050327')
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                st.subheader("✅ Interview Preparation Video")
